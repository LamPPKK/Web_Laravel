    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.products.update',$product->id)}}" enctype="multipart/form" method="POST" id="formCreateProduct">
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="title" value="{{$product->title}}" class="form-control" id="inputTitle"  placeholder="Nhập tiêu đề sản phẩm">
                                        @if ($errors->has('title'))
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="slug" value="{{$product->slug}}" class="form-control" id="inputSlug"  placeholder="Nhập slug bài viết">
                                        @if ($errors->has('slug'))
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="image">
                                            @if(!empty($product->image))
                                                <img src="{{$product->image}}" width="80" height="70" style="margin-left: 5px; margin-bottom: 5px;"/>
                                            @endif
                                        </div>
                                        @if ($errors->has('image'))
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="images" type="hidden" value="{{$product->images}}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$product->price_buy}}" name="price_buy" class="form-control formatPrice" id="inputPriceBuy"  placeholder="Nhập giá bán">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price_sale"  value="{{$product->price_sale}}" class="form-control formatPrice" id="inputPriceSale"  placeholder="Nhập giá sale">
                            ...
                            <div class="box box-primary boxCateScoll">
                                ...
                                <div class="box-body">
                                    ...
                                    @foreach($categories  as $cate)
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="categories[]" @php if(in_array($cate->id,$cates,true)) echo "checked" @endphp value="{{ $cate->id }}" class="flat-red">
                                                {{ $cate->title }}
                                            </label>
                                        </div>
                                    @endforeach
